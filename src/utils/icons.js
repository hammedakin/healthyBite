...
const ICON_ARROW_LEFT = <BsArrowLeft />;
...
const ICON_KEY = <BsFillKeyFill />;
const ICON_BIN = <MdDeleteForever />;
const ICON_LOCK = <BsFillLockFill />;
const ICON_VERIFIED = <MdVerified />;
const ICON_UNVERIFIED = <GoUnverified />;
const ICON_SHIELD = <FaUserShield />;
